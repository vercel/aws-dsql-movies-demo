  ...
  return (
    <div className="text-gray-800 dark:text-gray-200 text-sm border border-dashed border-gray-300 dark:border-gray-600 p-4 mb-4 font-mono bg-white dark:bg-gray-900">
      <p className="mb-2">
        ...
        Next.js and Vercel (
        <Link
          href="https://github.com/vercel/aws-dsql-movies-demo"
          target="_blank"
          rel="noreferrer"
      ...
      <p className="mb-2">
        <em className="text-amber-800 dark:text-yellow-300 not-italic font-normal">
          💡 Try quickly voting on movies to see their scores change!
        </em>
      </p>
    </div>
  );
